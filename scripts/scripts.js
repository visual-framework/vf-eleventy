...
var vfMasthead = require('vf-masthead/vf-masthead');
var vfTabs = require('vf-tabs/vf-tabs');
require('vf-form/vf-form__core/assets/float-labels.js');
var emblConditionalEdit = require('embl-conditional-edit/embl-conditional-edit');
require('embl-content-hub-loader/embl-content-hub-loader__html-imports');
require('embl-content-hub-loader/embl-content-hub-loader__fetch');
var emblContentHubLoader = require('embl-content-hub-loader/embl-content-hub-loader');
var emblBreadcrumbsLookup = require('embl-breadcrumbs-lookup/embl-breadcrumbs-lookup');
require('embl-content-meta-properties/embl-content-meta-properties');
...
vfTabs.vfTabs();
emblConditionalEdit.emblConditionalEdit();
