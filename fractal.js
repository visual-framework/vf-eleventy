// to do: this should be an import of vf-core's fractal config
// to do: codeblock should be an import from vf-core
// to do: vftheme should be an import from vf-core
module.exports = {
