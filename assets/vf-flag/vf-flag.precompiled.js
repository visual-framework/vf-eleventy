/**
 * Precompiled Nunjucks template: vf-flag.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["vf-flag"] = (function() {
...
(parentTemplate ? function(e, c, f, r, cb) { cb(""); } : context.getBlock("vf_flag__media"))(env, context, frame, runtime, function(t_8,t_7) {
...
(parentTemplate ? function(e, c, f, r, cb) { cb(""); } : context.getBlock("vf_flag__body"))(env, context, frame, runtime, function(t_10,t_9) {
