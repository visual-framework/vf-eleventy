/**
 * Precompiled Nunjucks template: vf-design-tokens--colours.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["vf-design-tokens--colours"] = (function() {
...
frame = frame.push();
var t_3 = runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "colors")),"properties");
...
output += "</p>\n      <p class=\"vf-swatch__sass-variable\">map-get($vf-colors-map, ";
output += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((t_4),"meta")),"sassVariable"), env.opts.autoescape);
output += ")</p>\n";
;
}
