/**
 * Precompiled Nunjucks template: vf-cluster--custom-spacing.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["vf-cluster--custom-spacing"] = (function() {
