/**
 * Precompiled Nunjucks template: vf-form__radio--clustered.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["vf-form__radio--clustered"] = (function() {
...
output += "<fieldset class=\"vf-form__fieldset | vf-stack vf-stack--400\">";
...
tasks.push(
function(callback) {
env.getTemplate("@vf-form__radio", false, "vf-form__radio--clustered", false, function(t_5,t_4) {
...
tasks.push(
function(callback) {
env.getTemplate("@vf-form__radio", false, "vf-form__radio--clustered", false, function(t_10,t_9) {
...
tasks.push(
function(callback) {
env.getTemplate("@vf-form__radio", false, "vf-form__radio--clustered", false, function(t_15,t_14) {
...
tasks.push(
function(callback) {
env.getTemplate("@vf-form__radio", false, "vf-form__radio--clustered", false, function(t_20,t_19) {
...
tasks.push(
function(callback) {
env.getTemplate("@vf-form__radio", false, "vf-form__radio--clustered", false, function(t_25,t_24) {
...
tasks.push(
function(callback) {
env.getTemplate("@vf-form__radio", false, "vf-form__radio--clustered", false, function(t_30,t_29) {
