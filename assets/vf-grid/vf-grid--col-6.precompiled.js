/**
 * Precompiled Nunjucks template: vf-grid--col-6.njk
 */
(function() {(window.nunjucksPrecompiled = window.nunjucksPrecompiled || {})["vf-grid--col-6"] = (function() {
...
env.getExtension("render")["run"](context,"@vf-box--normal-primary", function(t_22,t_21) {
if(t_22) { cb(t_22); return; }
output += runtime.suppressValue(t_21, true && env.opts.autoescape);
env.getExtension("render")["run"](context,"@vf-box--normal-primary", function(t_24,t_23) {
