...
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "summary__author_href"), env.opts.autoescape);
output += "\" class=\"vf-summary__author vf-summary__link\">";
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "summary__author"), env.opts.autoescape);
